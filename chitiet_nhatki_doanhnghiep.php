                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><input type="text" name="vi_tri_trang_trai" class="form-control"
                                    value="<?= htmlspecialchars($row['vi_tri_trang_trai']) ?>" required style="font-size: 18px;"></td>
                            <td><input type="text" name="phuong_phap_trong_trot" class="form-control"
                                    value="<?= htmlspecialchars($row['phuong_phap_trong_trot']) ?>" required style="font-size: 18px;"></td>
                            <td><input type="date" name="ngay_gieo_trong" class="form-control"
                                    value="<?= htmlspecialchars($row['ngay_gieo_trong']) ?>" required style="font-size: 18px;"></td>
                            <td><input type="date" name="ngay_thu_hoach" class="form-control"
                                    value="<?= htmlspecialchars($row['ngay_thu_hoach']) ?>" required style="font-size: 18px;"></td>
                            <td>
